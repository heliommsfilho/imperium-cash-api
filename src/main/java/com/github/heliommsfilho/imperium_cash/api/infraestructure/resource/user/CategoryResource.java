...
import com.github.heliommsfilho.imperium_cash.api.business.service.user.CategoryService;
...
import com.github.heliommsfilho.imperium_cash.api.domain.model.user.dto.category.CategoryGeneralResponseDTO;
...
public class CategoryResource extends AbstractResource {
    ...
    @ApiOperation(value = "Create a new Category", response = CategoryGeneralResponseDTO.class)
    ...
    public ResponseEntity<?> create(@RequestBody @Valid CategoryCreateDTO createDTO) {
        return created(categoryService.create(createDTO), CategoryGeneralResponseDTO.class);
    }
}
