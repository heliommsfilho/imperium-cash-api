...
import com.github.heliommsfilho.imperium_cash.api.business.service.system.currency.CurrencyService;
import com.github.heliommsfilho.imperium_cash.api.domain.model.system.Currency;
import com.github.heliommsfilho.imperium_cash.api.domain.model.system.dto.currency.CurrencyGeneralResponseDTO;
...
public class CurrencyResource extends AbstractResource {
    ...
    public ResponseEntity<List<?>> findAll() {
        return ok(this.currencyService.getAll(), CurrencyGeneralResponseDTO.class);
    }
