...
import com.github.heliommsfilho.imperium_cash.api.business.service.system.banklogo.BankLogoService;
import com.github.heliommsfilho.imperium_cash.api.domain.model.system.BankLogo;
import com.github.heliommsfilho.imperium_cash.api.domain.model.system.dto.banklogo.BankLogoGeneralResponseDTO;
...
public class BankLogoResource extends AbstractResource {
    ...
    public ResponseEntity<List<?>> getAll() {
        return ok(this.bankLogoService.getAll(), BankLogoGeneralResponseDTO.class);
    }
}
