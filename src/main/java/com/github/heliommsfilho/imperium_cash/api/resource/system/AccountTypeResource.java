...
import com.github.heliommsfilho.imperium_cash.api.business.service.internal.AccountTypeService;
import com.github.heliommsfilho.imperium_cash.api.domain.api.output.AccountTypeOutput;
...
public class AccountTypeResource extends AbstractResource {
    ...
    public ResponseEntity<List<?>> getAll() {
        return ok(accountTypeService.getAll(), AccountTypeOutput.class);
    }
}
