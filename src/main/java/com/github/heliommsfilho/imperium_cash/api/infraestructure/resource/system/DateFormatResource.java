...
import com.github.heliommsfilho.imperium_cash.api.business.service.system.dateformat.DateFormatService;
import com.github.heliommsfilho.imperium_cash.api.domain.model.system.DateFormat;
import com.github.heliommsfilho.imperium_cash.api.domain.model.system.dto.dateformat.DateFormatGeneralResponseDTO;
...
public class DateFormatResource extends AbstractResource {
    ...
    public ResponseEntity<List<?>> getAll() {
        return ok(dateFormatService.getAll(), DateFormatGeneralResponseDTO.class);
    }
}
